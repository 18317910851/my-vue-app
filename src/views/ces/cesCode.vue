...
import CustomReact from './comm/customReact.ts';
import userTask from "./comm/userTask.ts";
...
import {styleConfig} from "./comm/style"
  ...
  nodes: [
    {
      ...
      x: 100,
      y: 100,
      text: {x: 100, y: 100, value: '开始'}, // 节点文本
      properties: {
        width: 50,
        height: 50,
        style: {
...
onMounted(() => {
  ...
  // data数据
  // lf.value.register(CustomReact)
  // lf.value.render(data)

  // note数据
  // lf.value.render(notes.value)
